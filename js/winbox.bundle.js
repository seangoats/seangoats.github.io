...
(function () {
	...
	function S() {
		for (var a = y.length, b = 0, c, g; b < a; b++)
			(c = y[b]), (g = Math.min((L - 2 * c.left) / a, 250)), c.resize((g + 1) | 0, 35, !0).move((c.left + b * g) | 0, M - c.bottom - 35, !0);
	}
	function T(a, b) {
		function c(d) {
			t(d);
	...
	e.focus = function () {
		F !== this &&
			(w(this.g, 'z-index', B++), this.addClass('focus'), F && (F.removeClass('focus'), F.i && F.i()), (F = this), this.l && this.l());
		return this;
	};
	e.hide = function () {
	...
	e.resize = function (a, b, c) {
		'undefined' === typeof a
			...
			: c || ((this.width = a ? (a = R(a, L - this.left - this.right)) : 0), (this.height = b ? (b = R(b, M - this.top - this.bottom)) : 0));
		w(this.g, 'width', a + 'px');
